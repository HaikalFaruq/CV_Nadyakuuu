    ...
    return (
        <div className="spotify-badge-card" style={styles?.spotifyBadgeCard}>
            <div className="top">
                ...
                <div className="texts">
                    <p className="title-1" style={{ fontSize: '20px' }}>Information System</p>
                    <p className="title-2" style={{ fontSize: '15px' }}>Programming...</p>
                </div>
            </div>
            ...
            <div className="controls">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2" strokeLinejoin="round"
                     strokeLinecap="round" stroke="currentColor" fill="none" height="20" width="24">
                    <path
